...
import { serverUrl } from '../App'; // Ensure App.jsx has import.meta.env.VITE_API_URL
...
function SignIn() {
    ...
    const handleSignIn = async () => {
        ...
        setLoading(true)
        setErr("") // Previous errors clear karne ke liye

        try {
            // serverUrl should be defined as import.meta.env.VITE_API_URL in App.jsx
            ...
            // Login success hone par user ko home page par bhejna
            navigate("/") 
    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
                ...
                <p className='text-center mt-6 cursor-pointer text-sm' onClick={() => navigate("/signup")}>
                    Want to create a new account? <span className='text-[#ff4d2d] font-bold'>Sign Up</span>
                </p>
            </div>
        </div>
    )
